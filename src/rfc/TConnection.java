...
public class TConnection {
	...
	protected TConnection(Socket socket, int maxTPDUSizeParam, int messageTimeout, int messageFragmentTimeout) throws IOException {
		...
		maxTPDUSize = ClientOSI.getMaxTPDUSize(maxTPDUSizeParam);
		this.valid = true;
	}
